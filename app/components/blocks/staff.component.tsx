  ...
  return (
    <div data-tina-field={tinaField(data)}>
      <div className={'mb-8 md:mx-auto md:mb-12 text-center'}>
        {data.staff_title && (
          <h2 className={'font-bold leading-tighter tracking-tighter  text-heading text-3xl'}>
            {data.staff_title}
          </h2>
        )}
      </div>
          ...
          >
            ...
            <div className="flex flex-col w-full justify-center">
              ...
              {staff?.staff_person_role && (
                <p className="mt-2" data-tina-field={tinaField(staff, 'staff_person_role')}>
                  {staff?.staff_person_role}
                </p>
              )}
              {staff?.staff_person_description && (
                <p className="mt-4" data-tina-field={tinaField(staff, 'staff_person_description')}>
                  {staff?.staff_person_description}
                </p>
              )}
              <div className="mt-4">
