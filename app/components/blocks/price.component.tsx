...
export default function PriceBlock({
  ...
  return (
    <div className="container mx-auto px-4 py-12 text-center" data-tina-field={tinaField(data)}>
      {/* Price title */}
      {data.price_title && <h2 className="text-4xl font-extrabold text-heading mb-6">{data.price_title}</h2>}
                ...
                <div className="w-full max-w-sm bg-white rounded-lg shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all">
                  ...
                  {price.price_price && !price.price_contact_button && (
                    <div className="flex justify-center items-center mb-6">
                      <span className="text-2xl font-extrabold">{price.price_price}</span>
